...
require_once('Error.php'); // Don't know why this is needed!?
class Handler
{
	/**
	...
	public static function register()
	{
		switch (APPLICATION_ENV) {
			...
			case \Phalcon\Error\Application::ENV_DEVELOPMENT:
				ini_set('display_errors', 0); // I need this at 0 to handle errors on my own
				ini_set('display_startup_errors', 0); // I need this at 0 to handle errors on my own
				error_reporting(~0);
				break;
			default:
				ini_set('display_errors', 0);
